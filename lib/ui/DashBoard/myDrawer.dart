...
class _MyDrawerState extends State<MyDrawer> {
  ...
  Future<void> getUserData() async {
    ...
    userName = pref.getString('Name') ?? 'Admin';
    userUrl = pref.getString('ProfileUrl') ?? 'Default URL';
    userEmail = pref.getString('Email') ?? 'admin@admin.com';
  }

  Future<void> loaddata() async {
    await Future.wait([Info.getUser(), getUserData()]);
    await Info.getUser();
    await getUserData();
    setState(() {
      isLoading = false;
